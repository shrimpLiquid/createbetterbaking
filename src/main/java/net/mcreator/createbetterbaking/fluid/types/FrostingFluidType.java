...
@EventBusSubscriber
public class FrostingFluidType extends FluidType {
	public FrostingFluidType() {
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		event.registerFluidType(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse("crbeba:block/frosting_still");
		...
		}, CrbebaModFluidTypes.FROSTING_TYPE.get());
	}
}